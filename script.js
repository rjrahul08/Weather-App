...
function createCard(cityData) {
    ...
    {
        weatherImgString = "./weatherImages/cloudy.png";
    ...
    {
        weatherImgString = "./weatherImages/windy(2).png";
    } 
    if(cityData.weather[0].main == "Rain") 
    {
        weatherImgString = "./weatherImages/Rainy.png";
    } 
    if(cityData.weather[0].main == "Drizzle") 
    {
        weatherImgString = "./weatherImages/Tornado.png";
    } 
